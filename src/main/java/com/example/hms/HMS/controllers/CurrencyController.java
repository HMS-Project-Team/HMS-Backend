...
public class CurrencyController {
        ...
        @RequirePrivilege(privilege = "/currency", type = PrivilegeType.WRITE_ACCESS)
        public ResponseEntity<ResponseWrapper<CurrencyResponseDto>> createCurrency(
        ...
        @RequirePrivilege(privilege = "/currency", type = PrivilegeType.MAINTAIN_ACCESS)
        ...
        @GetMapping
        @RequirePrivilege(privilege = "/currency", type = PrivilegeType.READ_ACCESS)
